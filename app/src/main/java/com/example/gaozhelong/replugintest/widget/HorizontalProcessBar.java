package com.example.gaozhelong.replugintest.widget;
...
public class HorizontalProcessBar extends View {
    ...
    public HorizontalProcessBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
        initPaint();
    }
     ...
     * @return
     */
    public HorizontalProcessBar setProgressWithAnimation(float progress) {
        mProgress = progress;
        initAnimation();
        return this;
    }
     ...
     * @return
     */
    public HorizontalProcessBar setCurrentProgress(float progress) {
        mProgress = progress;
     ...
     * @return
     */
    public HorizontalProcessBar setProgressListener(ProgressListener listener) {
